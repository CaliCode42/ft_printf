...
/*   Updated: 2024/12/18 15:20:09 by tcali            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	ft_print_signed(t_list *list)
{
	long	nb_long;
...
static void	ft_print_unsigned(t_list *list)
{
...
static void	ft_print_void(t_list *list)
{
	void			*ptr;
...
static void	ft_print_hexa(t_list *list)
{
