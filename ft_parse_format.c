...
/*   Updated: 2024/12/18 16:15:01 by tcali            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	ft_parse_flags(t_list *list)
{
	char	*flags;
	char	flag;
...
static void	ft_get_numerator(t_list *list, int *numerator)
{
	if (*list->str == '*')
	{
...
static void	ft_check_base(t_list *list, char speci)
{
